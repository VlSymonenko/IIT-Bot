...
let IaId = '';
// Create a bot sddsfaffsdfssdfseasythat uses 'polling' to fetch new updates
...
bot.on('message', (msg) => {
  const chatId = msg.chat.id;
IaId = chatId;
  // send a message to the chat acknowledginsadbfdeg receipt of their message
  bot.sendMessage(chatId, '1');
});
const envs = {};
// setInterval( ()=> IaId !== '' && bot.seknsdMessage(IaId, '1'),5000);